...
from prohmr.models import ProHMRDepthEgobody, ProHMRHHAEgobody
...
# Setup model
model = ProHMRHHAEgobody(cfg=model_cfg, device=device)
...
test_dataset = ImageDatasetHHAEgoBody(cfg=model_cfg, train=False, device=device, img_dir=args.dataset_root,
