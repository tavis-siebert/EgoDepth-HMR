...
def train(writer, logger):
    ...
    # Setup model
    model = ProHMRSurfnormalsEgobody(cfg=model_cfg, device=device, smplx_data_dir=smplx_data_dir, writer=None, logger=None, with_global_3d_loss=args.with_global_3d_loss)
    model.train()
